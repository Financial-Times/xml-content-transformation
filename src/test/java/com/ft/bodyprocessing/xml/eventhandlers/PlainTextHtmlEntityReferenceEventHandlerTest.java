...
public class PlainTextHtmlEntityReferenceEventHandlerTest extends BaseXMLEventHandlerTest {
    ...
    public void setUp() throws Exception {
        htmlEntityReferenceEventHandler = new PlainTextHtmlEntityReferenceEventHandler();
    }
    ...
    public void testHandleEntityReferenceEventForUnknownEntity() throws Exception {
        ...
        verify(eventWriter).write("&someEntity;");
    }
}
